...
export const googleOauth = `https://accounts.google.com/o/oauth2/auth?client_id=${GOOGLE_CID}&redirect_uri=http://localhost:3090/auth&response_type=code&scope=https://www.googleapis.com/auth/userinfo.email&approval_prompt=force&access_type=offline`
