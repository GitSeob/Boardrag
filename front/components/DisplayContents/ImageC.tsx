import React, { FC, MutableRefObject, useState, useEffect, useCallback, useRef } from 'react';
...
const ImageC:FC<ITF> = ({isEdit, url, setEdit, onSubmitEdit, board}) => {
	...
	}, [imageInput.current]);const onChangeImg = useCallback( async (e) => {
		...
		return (
			...
			<EditButtonBox>
				<div
					...
					onClick={() => {onSubmitEdit("", "", uploading.imageURL) }}
				>수정</div>
				<div
					className="button"
